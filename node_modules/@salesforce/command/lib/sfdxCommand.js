...
class SfdxCommand extends command_1.default {
    ...
    async catch(err) {
        ...
        const userDisplayError = Object.assign(this.getJsonResultObject(error.data, error.exitCode), Object.assign({}, error.toObject(), { stack: error.stack, warnings: Array.from(ux_1.UX.warnings) }));
        if (this.isJson) {
    ...
    warnIfDeprecated() {
        if (this.statics.deprecated) {
            ...
            if (ts_types_2.has(this.statics.deprecated, 'version')) {
                def = Object.assign({ name: this.statics.name, type: 'command' }, this.statics.deprecated);
            }
            else {
        ...
        if (this.statics.flagsConfig) {
            ...
            for (const flag of Object.keys(this.flags)) {
                ...
                if (def && def.deprecated) {
                    this.ux.warn(ux_1.UX.formatDeprecationWarning(Object.assign({ name: flag, type: 'flag' }, def.deprecated)));
                }
            }
        }
    }
